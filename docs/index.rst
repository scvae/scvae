...
scVAE was developed by `Christopher Heje Grønbech`_ and `Maximillian Fornitz Vording`_ with Christopher continuing its development. The methods used are described and examined in :ref:`Grønbech et al. (2018) <groenbech2018>`.
