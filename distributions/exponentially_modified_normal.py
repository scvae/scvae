...
class ExponentiallyModifiedNormal(distribution.Distribution):
  """The exponentially modified normal (Gaussian) distribution with location `loc`, `scale` and `rate` parameters.
  ...
  * `Z` is the normalization constant.
  ...
  def __init__(self,
    ...
    Args:
      loc: Floating point tensor; the means of the normal component of the
        distribution(s).
      scale: Floating point tensor; the stddevs of the normal component of the
        distribution(s). Must contain only positive values.
      rate: Floating point tensor; the rate of the exponential component of
