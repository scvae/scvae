...
class NonPermutedMultinomial(distribution.Distribution):
  """Non-Permuted Multinomial distribution.
  ...
  def _log_prob(self, counts):
    ...
    log_unnormalized_prob = counts * math_ops.log(self.p)
    #log_normalizer = -distribution_util.log_combinations(self.n, counts)
    return log_unnormalized_prob
